...
var _Injector = __webpack_require__(8);

var _ShortcodeSerialiser = __webpack_require__(9);

var _ShortcodeSerialiser2 = _interopRequireDefault(_ShortcodeSerialiser);

var _InsertShortcodeModal = __webpack_require__(10);
...
var InjectableInsertShortcodeModal = (0, _Injector.loadComponent)(_InsertShortcodeModal2.default);
...
(function () {
    var ssembed = {
        init: function init(editor, url) {
            ...
            editor.addCommand('shortcodable', function () {
                (0, _jquery2.default)('#' + editor.id).entwine('ss').openShortCodeDialog();
            });
    ...
    tinymce.PluginManager.add('shortcodable', function (editor, url) {
        return ssembed.init(editor, url);
    });
})();
...
_jquery2.default.entwine('ss', function ($) {
    ...
    $('.js-injector-boot #insert-shortcode-react__dialog-wrapper').entwine({
        ...
        getHTML: function getHTML() {
            ...
            var type = data.ShortcodeClass.replace(/\\/g, "_");
...
var _SchemaActions = __webpack_require__(14);
...
var sectionConfigKey = 'Silverstripe\\Shortcodable\\Controller\\ShortcodableController';

var InsertShortcodeModal = function (_Component) {
    _inherits(InsertShortcodeModal, _Component);

    function InsertShortcodeModal(props) {
        _classCallCheck(this, InsertShortcodeModal);

        var _this = _possibleConstructorReturn(this, (InsertShortcodeModal.__proto__ || Object.getPrototypeOf(InsertShortcodeModal)).call(this, props));

        _this.handleSubmit = _this.handleSubmit.bind(_this);
        return _this;
    }

    _createClass(InsertShortcodeModal, [{
...
function mapStateToProps(state, ownProps) {
    ...
    var attrs = ownProps.shortcodeAttributes;
    ...
    if (typeof ownProps.shortCodeClass !== 'undefined') {
        ...
        if (attrs) {
            delete attrs.type;
            schemaUrl = schemaUrl + '&' + _jquery2.default.param(attrs);
        }
    }
...
exports.Component = InsertShortcodeModal;
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(InsertShortcodeModal);
...
/***/ })
/******/ ]);
//# sourceMappingURL=TinyMCE_shortcodable.js.map
